 ...
 */
final class Version20211215134019 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE animaux (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, name VARCHAR(255) NOT NULL, age INT NOT NULL, race VARCHAR(255) NOT NULL, picture VARCHAR(255) NOT NULL, vaccinate TINYINT(1) NOT NULL, sterilized TINYINT(1) NOT NULL, puced TINYINT(1) NOT NULL, castration TINYINT(1) NOT NULL, sexe VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, tatoo TINYINT(1) NOT NULL, slug VARCHAR(255) NOT NULL, INDEX IDX_9ABE194D12469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
